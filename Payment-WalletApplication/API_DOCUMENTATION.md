...
### 6.3 Get all customer transactions
...
### 6.6 Get transactions by subcategory
...
### 6.7 Get transactions by month
- URL: `GET /auth/transactions/month?month=4&year=2026`

---

### 6.8 Delete transaction
