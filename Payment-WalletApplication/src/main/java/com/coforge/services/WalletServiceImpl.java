...
//		System.out.println(wallet);
	...
	public Wallet getWallet() {
		...
		Wallet wallet =  walletRepository.findWalletByCustomerId(customer.getCustId()).orElseThrow(() -> new RuntimeException("Wallet not found"));
	...
	public Wallet getWalletByCustomerId(long custId) {
		...
		Wallet wallet =  walletRepository.findWalletByCustomerId(custId).orElseThrow(() -> new RuntimeException("Wallet not found"));
